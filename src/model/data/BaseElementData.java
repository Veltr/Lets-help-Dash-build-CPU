...
public abstract class BaseElementData {
    ...
    protected abstract SignalData getDataFromPort(int index);
    protected abstract void addNextElements(AbstractCollection<BaseElementData> out) throws NullConnectionException;
